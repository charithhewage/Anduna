function drawTodayVisitsChart(dataset){
    ...
    var tempWidth = document.getElementById('headChartRequests').clientWidth - parseInt('40px', 10), 
        tempheight = document.getElementById('headChartRequests').clientHeight - parseInt('20px', 10);
    ...
    var tip = d3.tip()
        ...
        .offset([-10, 0])
        .html(function(d) {
            return "<div style=' height:25px; width:145px; border-radius: 2px; background-color: #302929; padding-left: 8px; padding-top: 3px;'><strong style='color:white;'>Count&nbsp;:&nbsp;</strong><span style='color:red;'>" + d.requests+ "</span></div>";
        });
    ...
    var chart = d3.select("#ChartRequests").append('svg')
    ...
    chart.append("text")
        ...
        .text("Proxy log requests based on date and month");
...
function drawTodayUniqVisitsChart(dataset){
    ...
    var tempWidth = document.getElementById('headChartUsers').clientWidth - parseInt('40px', 10), 
        tempheight = document.getElementById('headChartUsers').clientHeight - parseInt('20px', 10);
    ...
    var tip = d3.tip()
        ...
        .offset([-10, 0])
        .html(function(d) {
            return "<div style=' height:25px; width:145px; border-radius: 2px; background-color: #302929; padding-left: 8px; padding-top: 3px;'><strong style='color:white;'>Users&nbsp;:&nbsp;</strong><span style='color:red;'>" + d.users+ "</span></div>";
        });
    ...
    //var chart = d3.select(".chart")
    var chart = d3.select("#ChartUsers").append('svg')
        .attr("id","visitsBar")// id for svg chart
        .attr("width", width + margin.left + margin.right)
        .attr("height", height + margin.top + margin.bottom)
        .append("g")
    ...
    x.domain(dataset.map(function(d) { return d.date; }));
    y.domain([0, d3.max(dataset, function(d) { return d.users; })]);
    ...
    chart.append("text")
        ...
        .style("font-size", "16px") 
        .style("text-decoration", "underline")  
        .text("Proxy log users based on date and month");
...
function drawHighestRequestedSites(dataset){

        var tempWidth = document.getElementById('headChartheighestVisited').clientWidth - parseInt('10px', 10), 
        tempheight = document.getElementById('headChartheighestVisited').clientHeight - parseInt('10px', 10);
       ...
       var margin = {top: 40, right: 15, bottom: 15, left: 40},
        ...
        var chart = d3.select('#ChartheighestVisited')
          .append('svg')
          .attr("id","piechart")
          .attr('width', width)
          .attr('height', height)
        ...
        chart.append("text")
            ...
            .style("text-decoration", "underline")  
            .text("Top 5 web sites with high requests via Proxy Serve");
...
function drawFailedVisitsChart(dataset){
    ...
    var tempWidth = document.getElementById('headChartFailedVisits').clientWidth - parseInt('40px', 10), 
        tempheight = document.getElementById('headChartFailedVisits').clientHeight - parseInt('20px', 10);
    ...
    //var chart = d3.select(".chart")
    var chart = d3.select("#ChartFailedVisits").append('svg')
        .attr("id","visitsBar")// id for svg chart
        .attr("width", width + margin.left + margin.right)
        .attr("height", height + margin.top + margin.bottom)
        .append("g")
