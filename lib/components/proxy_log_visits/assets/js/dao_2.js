...
function show_today_visits(){
  ...
  $.getJSON(widgController.proxy_log_visits, function(response){
    ...
    switch(true) {
		...
		showAvg = '<div class="stat-percent font-bold text-info '+color+'">'+ (Math.round(avgRequests* 100 )/100)+ '%' + icon + '</div>'
    ...
    var appendData = `
      ...
      <div class="row border-bottom">
        ...
        <div class="col-xs-2"> `+showAvg+` </div>
        <div class="col-xs-5">
				...
				<div class="tabs-container" style="min-height:300px">
				  <div class="tabs-left">
				      <ul class="nav nav-tabs">
				          ...
				          <li><a data-toggle="tab" href="#AvgVisits" aria-expanded="false">Average Visits</a></li>
