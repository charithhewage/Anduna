function draw404RequestIpBasedBarChart(dataset){
    ...
    chart.selectAll(".bar")
        ...
        .on("click", function(d){ 
            ...
            $("#access_404_modal_content .browser").html("<td><p><strong>Browser&nbsp;&nbsp;</strong></p></td><td><p>:&nbsp;&nbsp;</p></td><td><p>"+browser+"</p></td>");
            $("#access_404_modal_content .os").html("<td><p><strong>Operating System&nbsp;&nbsp;</strong></p></td><td><p>:&nbsp;&nbsp;</p></td><td><p>"+os+"</p></td>");
            //$('#info_div').modal('show');
            //$('#myModal').modal('hide');
