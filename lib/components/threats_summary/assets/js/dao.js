        ...
        <div class="tabs-container" style="min-height:300px">
          <div class="tabs-left">
            <ul class="nav nav-tabs">
              ...
              <li><a data-toggle="tab" href="#failedRequests" aria-expanded="false"></a></li>
              <li><a data-toggle="tab" href="#failedRequests" aria-expanded="false"></a></li>
              ...
              <div class="tab-content ">
                  <div id="proxyThreats" class="tab-pane active">
                    <div class="panel-body">
                      <div id="headproxyThreatsChart" class="row">
                  ...
                  <div id="accessThreats" class="tab-pane">
                      <div class="panel-body">
                          <div id="headaccessThreatsChart" class="row">
