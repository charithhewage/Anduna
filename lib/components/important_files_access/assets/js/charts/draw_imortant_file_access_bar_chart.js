function drawImportantFileAccessBarChart(dataset){
    ...
    chart.selectAll(".bar")
        ...
        .on("click", function(d){ 
            ...
            //d3.select(this).style("fill", "#CA3A3A");
            $("#importnat_file_access_modal_content .clientIp").html(d.name);
            $("#importnat_file_access_modal_content .count").html(d.value);
            $("#importnat_file_access_modal_content .size").html(d.req_size);
