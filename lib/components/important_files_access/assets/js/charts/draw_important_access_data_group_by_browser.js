       ...
       var margin = {top: 40, right: 15, bottom: 15, left: 40},
        ...
        var path = chart.selectAll('path')
          ...
          .on("click", function(d){ 
            ...
            //d3.select(this).style("fill", "#CA3A3A");
            $("#importnat_file_access_modal_content .clientIp").html(d.data.name);
            $("#importnat_file_access_modal_content .count").html(d.data.value);
            $("#importnat_file_access_modal_content .size").html(d.data.req_size);
            ...
            // $("#importnat_file_access_modal_content .browser").html(browser);
            // $("#importnat_file_access_modal_content .os").html(os);
            //$('#info_div').modal('show');
            //$('#myModal').modal('hide');
