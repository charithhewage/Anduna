function drawImportantFileAccessByRequestPieChart(dataset){
  ...
  var tempWidth = document.getElementById('importnat_file_access_div').clientWidth - parseInt('10px', 10), 
       ...
       var margin = {top: 40, right: 15, bottom: 15, left: 40},
        ...
        .offset([-10, 0])
        .html(function(d) {
            return "<div style=' height:25px; width:145px; border-radius: 2px; background-color: #302929; padding-left: 8px; padding-top: 3px;'><strong style='color:white;'>Request Type&nbsp;:&nbsp;</strong><span style='color:red;'>" + d.data.name + "</span></div>";
        });
        ...
        var path = chart.selectAll('path')
          ...
          .on("click", function(d){ 
            ...
            //d3.select(this).style("fill", "#CA3A3A");
            $("#importnat_file_access_modal_content .clientIp").html("<td><h4><strong>Request Type&nbsp;&nbsp;</strong></h4></td><td><h4>:&nbsp;&nbsp;</h4></td><td><h4 id='paramImportantFile'>"+d.data.name+"</h4></td>");
            ...
            $("#importnat_file_access_modal_content .browser").html("<td><strong></strong></p></td><td><p></p></td><td><p></p></td>");
            $("#importnat_file_access_modal_content .os").html("<td><strong></strong></p></td><td><p></p></td><td><p></p></td>");
            //$('#info_div').modal('show');
            //$('#myModal').modal('hide');
