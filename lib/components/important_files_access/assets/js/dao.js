var controllers ={
  ...
  important_access_data_group_by_date: "lib/components/important_files_access/controllers/important_access_data_group_by_date.jag",
}
...
console.log("inside get_important_file_accessed_data_grp_by_browser");
...
function get_data_group_by_date(){

console.log("inside get_important_file_accessed_data_grp_by_date");

    $.getJSON(controllers.important_access_data_group_by_date , function (response){
        console.log(" impornt file grup by browser  working");
        ...
        $.each(response, function (key, val) {
            ...
            dataset.push({name : val.date,value : val.totalcount, req_size : val.request_size, browser_info : val.browserInfo});
                ...
                drawImportantFileAccessByDateLineChart(dataset);
