              ...
              <div class="tab-content ">
                  <div id="todayhits" class="tab-pane active">
                    <div class="panel-body">
                      <div id="headChartHits"class="row" width="440" height="350">
                  ...
                  <div id="todayUnHisits" class="tab-pane">
                      <div class="panel-body">
                          <div id="headChartUnique"class="row" width="440" height="350">
                  ...
                  <div id="heighestHit" class="tab-pane">
                    <div class="panel-body">
                      <div id="headChartheighestAccessed" class="row" width="440" height="350">
                  ...
                  <div id="failedHits" class="tab-pane">
                      <div class="panel-body">
                        <div id="headChartFailedHits" class="row" width="440" height="350">
                          <div id="ChartFailedHits"></div>
                        </div>
                      </div>
                  </div>
